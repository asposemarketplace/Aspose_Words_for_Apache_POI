package asposefeatures.workingwithbarcode.insertbarcodeoneachpage.java;
...
{
    static String dataPath = "src/asposefeatures/workingwithbarcode/insertbarcodeoneachpage/data/";
	...
	// to a stream.
	doc.save(dataPath + "AsposeBarcodeOnEachPage.docx");
